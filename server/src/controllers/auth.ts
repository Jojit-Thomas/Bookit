...
const admin_login: RequestHandler = (req, res) => {
  try {
    ...
    if (!err.status) res.status(500).json("Internal Server Error")
  }
}



export default { login, register, refreshAccessToken, logout, admin_login };